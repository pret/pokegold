...
gfx/intro/water1.2bpp.lz: LZFLAGS += --odd-alternate --align 4
...
gfx/slots/slots_1.2bpp.lz: LZFLAGS += --odd-alternate --align 4
gfx/slots/slots_2.2bpp.lz: LZFLAGS += --align 4
gfx/slots/slots_3.2bpp.lz: LZFLAGS += --align 4

gfx/tilesets/%.lz: LZFLAGS += --align 4
gfx/tilesets/game_corner.2bpp.lz: LZFLAGS += --odd-alternate --align 4
...
gfx/tilesets/players_room.2bpp.lz: LZFLAGS += --no-lookback-3 --align 4
gfx/tilesets/radio_tower.2bpp.lz: LZFLAGS += --odd-alternate --align 4
gfx/tilesets/ruins_of_alph.2bpp.lz: LZFLAGS += --odd-alternate --no-lookback-3 --align 4
