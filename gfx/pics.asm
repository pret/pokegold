...
NidokingFrontpic:    INCBIN "gfx/pokemon/nidoking/front.2bpp.lz"
HoOhFrontpic:        INCBIN "gfx/pokemon/ho_oh/front.2bpp.lz"
GyaradosFrontpic:    INCBIN "gfx/pokemon/gyarados/front.2bpp.lz"
MachampFrontpic:     INCBIN "gfx/pokemon/machamp/front.2bpp.lz"
...
RhydonFrontpic:      INCBIN "gfx/pokemon/rhydon/front.2bpp.lz"
RaikouFrontpic:      INCBIN "gfx/pokemon/raikou/front.2bpp.lz"
TaurosFrontpic:      INCBIN "gfx/pokemon/tauros/front.2bpp.lz"
NidoqueenFrontpic:   INCBIN "gfx/pokemon/nidoqueen/front.2bpp.lz"
RapidashFrontpic:    INCBIN "gfx/pokemon/rapidash/front.2bpp.lz"
...
ArbokFrontpic:       INCBIN "gfx/pokemon/arbok/front.2bpp.lz"
CharizardFrontpic:   INCBIN "gfx/pokemon/charizard/front.2bpp.lz"
SkarmoryFrontpic:    INCBIN "gfx/pokemon/skarmory/front.2bpp.lz"
WeezingFrontpic:     INCBIN "gfx/pokemon/weezing/front.2bpp.lz"
VenusaurFrontpic:    INCBIN "gfx/pokemon/venusaur/front.2bpp.lz"
BeedrillFrontpic:    INCBIN "gfx/pokemon/beedrill/front.2bpp.lz"
LugiaFrontpic:       INCBIN "gfx/pokemon/lugia/front.2bpp.lz"
NidorinoFrontpic:    INCBIN "gfx/pokemon/nidorino/front.2bpp.lz"


SECTION "Pics 2", ROMX

KingdraFrontpic:     INCBIN "gfx/pokemon/kingdra/front.2bpp.lz"
SandslashFrontpic:   INCBIN "gfx/pokemon/sandslash/front.2bpp.lz"
JumpluffFrontpic:    INCBIN "gfx/pokemon/jumpluff/front.2bpp.lz"
...
LickitungFrontpic:   INCBIN "gfx/pokemon/lickitung/front.2bpp.lz"
ChuckPic:            INCBIN "gfx/trainers/chuck.2bpp.lz"
ParasectFrontpic:    INCBIN "gfx/pokemon/parasect/front.2bpp.lz"
ButterfreeBackpic:   INCBIN "gfx/pokemon/butterfree/back.2bpp.lz"
KimonoGirlPic:       INCBIN "gfx/trainers/kimono_girl.2bpp.lz"
FearowFrontpic:      INCBIN "gfx/pokemon/fearow/front.2bpp.lz"
...
GolbatFrontpic:      INCBIN "gfx/pokemon/golbat/front.2bpp.lz"
...
StarmieFrontpic:     INCBIN "gfx/pokemon/starmie/front.2bpp.lz"
KabutopsFrontpic:    INCBIN "gfx/pokemon/kabutops/front.2bpp.lz"
DodrioBackpic:       INCBIN "gfx/pokemon/dodrio/back.2bpp.lz"
HitmonleeFrontpic:   INCBIN "gfx/pokemon/hitmonlee/front.2bpp.lz"
VenomothFrontpic:    INCBIN "gfx/pokemon/venomoth/front.2bpp.lz"
...
NoctowlFrontpic:     INCBIN "gfx/pokemon/noctowl/front.2bpp.lz"
...
GravelerFrontpic:    INCBIN "gfx/pokemon/graveler/front.2bpp.lz"
MrMimeFrontpic:      INCBIN "gfx/pokemon/mr__mime/front.2bpp.lz"
...
NidorinaFrontpic:    INCBIN "gfx/pokemon/nidorina/front.2bpp.lz"
...
GolemFrontpic:       INCBIN "gfx/pokemon/golem/front.2bpp.lz"
...
GastlyFrontpic:      INCBIN "gfx/pokemon/gastly/front.2bpp.lz"
...
CharmeleonFrontpic:  INCBIN "gfx/pokemon/charmeleon/front.2bpp.lz"
WartortleFrontpic:   INCBIN "gfx/pokemon/wartortle/front.2bpp.lz"
SeelFrontpic:        INCBIN "gfx/pokemon/seel/front.2bpp.lz"
...
PonytaFrontpic:      INCBIN "gfx/pokemon/ponyta/front.2bpp.lz"
...
PoliwhirlFrontpic:   INCBIN "gfx/pokemon/poliwhirl/front.2bpp.lz"
...
TogeticFrontpic:     INCBIN "gfx/pokemon/togetic/front.2bpp.lz"
...
GloomFrontpic:       INCBIN "gfx/pokemon/gloom/front.2bpp.lz"
...
FurretFrontpic:      INCBIN "gfx/pokemon/furret/front.2bpp.lz"
...
VileplumeFrontpic:   INCBIN "gfx/pokemon/vileplume/front.2bpp.lz"
...
PidgeottoFrontpic:   INCBIN "gfx/pokemon/pidgeotto/front.2bpp.lz"
...
HaunterFrontpic:     INCBIN "gfx/pokemon/haunter/front.2bpp.lz"
...
WigglytuffFrontpic:  INCBIN "gfx/pokemon/wigglytuff/front.2bpp.lz"
...
ChinchouFrontpic:    INCBIN "gfx/pokemon/chinchou/front.2bpp.lz"
...
MeowthFrontpic:      INCBIN "gfx/pokemon/meowth/front.2bpp.lz"
...
WeepinbellFrontpic:  INCBIN "gfx/pokemon/weepinbell/front.2bpp.lz"
...
KrabbyFrontpic:      INCBIN "gfx/pokemon/krabby/front.2bpp.lz"
IvysaurFrontpic:     INCBIN "gfx/pokemon/ivysaur/front.2bpp.lz"
MukBackpic:          INCBIN "gfx/pokemon/muk/back.2bpp.lz"
DelibirdBackpic:     INCBIN "gfx/pokemon/delibird/back.2bpp.lz"
LanturnFrontpic:     INCBIN "gfx/pokemon/lanturn/front.2bpp.lz"
...
MankeyFrontpic:      INCBIN "gfx/pokemon/mankey/front.2bpp.lz"
...
AbraFrontpic:        INCBIN "gfx/pokemon/abra/front.2bpp.lz"
...
StaryuFrontpic:      INCBIN "gfx/pokemon/staryu/front.2bpp.lz"
...
ShellderFrontpic:    INCBIN "gfx/pokemon/shellder/front.2bpp.lz"
JolteonBackpic:      INCBIN "gfx/pokemon/jolteon/back.2bpp.lz"
EkansFrontpic:       INCBIN "gfx/pokemon/ekans/front.2bpp.lz"
ParasectBackpic:     INCBIN "gfx/pokemon/parasect/back.2bpp.lz"
AipomFrontpic:       INCBIN "gfx/pokemon/aipom/front.2bpp.lz"
...
CharmanderFrontpic:  INCBIN "gfx/pokemon/charmander/front.2bpp.lz"
ChinchouBackpic:     INCBIN "gfx/pokemon/chinchou/back.2bpp.lz"
HoothootFrontpic:    INCBIN "gfx/pokemon/hoothoot/front.2bpp.lz"
SpearowBackpic:      INCBIN "gfx/pokemon/spearow/back.2bpp.lz"
ChanseyBackpic:      INCBIN "gfx/pokemon/chansey/back.2bpp.lz"
MachopFrontpic:      INCBIN "gfx/pokemon/machop/front.2bpp.lz"
...
BellsproutFrontpic:  INCBIN "gfx/pokemon/bellsprout/front.2bpp.lz"
SandshrewFrontpic:   INCBIN "gfx/pokemon/sandshrew/front.2bpp.lz"
...
DoduoFrontpic:       INCBIN "gfx/pokemon/doduo/front.2bpp.lz"
...
JigglypuffFrontpic:  INCBIN "gfx/pokemon/jigglypuff/front.2bpp.lz"
...
PikachuFrontpic:     INCBIN "gfx/pokemon/pikachu/front.2bpp.lz"
...
NidoranMFrontpic:    INCBIN "gfx/pokemon/nidoran_m/front.2bpp.lz"
...
PidgeyFrontpic:      INCBIN "gfx/pokemon/pidgey/front.2bpp.lz"
ZubatFrontpic:       INCBIN "gfx/pokemon/zubat/front.2bpp.lz"
...
ParasFrontpic:       INCBIN "gfx/pokemon/paras/front.2bpp.lz"
...
SkiploomFrontpic:    INCBIN "gfx/pokemon/skiploom/front.2bpp.lz"
...
TentacoolFrontpic:   INCBIN "gfx/pokemon/tentacool/front.2bpp.lz"
...
SlowpokeFrontpic:    INCBIN "gfx/pokemon/slowpoke/front.2bpp.lz"
ElectrodeFrontpic:   INCBIN "gfx/pokemon/electrode/front.2bpp.lz"
AzumarillBackpic:    INCBIN "gfx/pokemon/azumarill/back.2bpp.lz"
SpearowFrontpic:     INCBIN "gfx/pokemon/spearow/front.2bpp.lz"
...
SentretFrontpic:     INCBIN "gfx/pokemon/sentret/front.2bpp.lz"
PoliwagFrontpic:     INCBIN "gfx/pokemon/poliwag/front.2bpp.lz"
...
GeodudeFrontpic:     INCBIN "gfx/pokemon/geodude/front.2bpp.lz"
...
IgglybuffFrontpic:   INCBIN "gfx/pokemon/igglybuff/front.2bpp.lz"
...
KakunaFrontpic:      INCBIN "gfx/pokemon/kakuna/front.2bpp.lz"
SwinubFrontpic:      INCBIN "gfx/pokemon/swinub/front.2bpp.lz"
NatuBackpic:         INCBIN "gfx/pokemon/natu/back.2bpp.lz"
OddishFrontpic:      INCBIN "gfx/pokemon/oddish/front.2bpp.lz"
...
TogepiFrontpic:      INCBIN "gfx/pokemon/togepi/front.2bpp.lz"
...
AlakazamFrontpic:    INCBIN "gfx/pokemon/alakazam/front.2bpp.lz"
...
MachokeFrontpic:     INCBIN "gfx/pokemon/machoke/front.2bpp.lz"
...
DodrioFrontpic:      INCBIN "gfx/pokemon/dodrio/front.2bpp.lz"
ButterfreeFrontpic:  INCBIN "gfx/pokemon/butterfree/front.2bpp.lz"
PidgeotFrontpic:     INCBIN "gfx/pokemon/pidgeot/front.2bpp.lz"
PersianFrontpic:     INCBIN "gfx/pokemon/persian/front.2bpp.lz"
DewgongFrontpic:     INCBIN "gfx/pokemon/dewgong/front.2bpp.lz"
CloysterFrontpic:    INCBIN "gfx/pokemon/cloyster/front.2bpp.lz"
GolduckFrontpic:     INCBIN "gfx/pokemon/golduck/front.2bpp.lz"
ArcanineFrontpic:    INCBIN "gfx/pokemon/arcanine/front.2bpp.lz"
OnixFrontpic:        INCBIN "gfx/pokemon/onix/front.2bpp.lz"
...
PrimeapeFrontpic:    INCBIN "gfx/pokemon/primeape/front.2bpp.lz"
RaichuFrontpic:      INCBIN "gfx/pokemon/raichu/front.2bpp.lz"
...
KinglerFrontpic:     INCBIN "gfx/pokemon/kingler/front.2bpp.lz"
PoliwrathFrontpic:   INCBIN "gfx/pokemon/poliwrath/front.2bpp.lz"
PinsirFrontpic:      INCBIN "gfx/pokemon/pinsir/front.2bpp.lz"
MewtwoFrontpic:      INCBIN "gfx/pokemon/mewtwo/front.2bpp.lz"
SlowbroFrontpic:     INCBIN "gfx/pokemon/slowbro/front.2bpp.lz"
KadabraFrontpic:     INCBIN "gfx/pokemon/kadabra/front.2bpp.lz"
...
VoltorbFrontpic:     INCBIN "gfx/pokemon/voltorb/front.2bpp.lz"
...
HoppipFrontpic:      INCBIN "gfx/pokemon/hoppip/front.2bpp.lz"
...
SquirtleFrontpic:    INCBIN "gfx/pokemon/squirtle/front.2bpp.lz"
EeveeBackpic:        INCBIN "gfx/pokemon/eevee/back.2bpp.lz"
GengarFrontpic:      INCBIN "gfx/pokemon/gengar/front.2bpp.lz"
...
HitmonchanFrontpic:  INCBIN "gfx/pokemon/hitmonchan/front.2bpp.lz"
...
NidoranFFrontpic:    INCBIN "gfx/pokemon/nidoran_f/front.2bpp.lz"
SlowkingFrontpic:    INCBIN "gfx/pokemon/slowking/front.2bpp.lz"
VictreebelFrontpic:  INCBIN "gfx/pokemon/victreebel/front.2bpp.lz"
