...
; SGBLayoutJumptable indexes (see engine/gfx/sgb_layouts.asm)
	...
	const SCGB_POKEGEAR_MAP
	const SCGB_POKEGEAR_RADIO
	const SCGB_POKEDEX_MAP
	const SCGB_POKEDEX_LIST
...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_POKEGEAR_MAP
	const PREDEFPAL_POKEGEAR_RADIO
	const PREDEFPAL_POKEDEX_LIST_PAL
