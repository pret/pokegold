...
DEF LINK_PARTY_DATA_PADDING EQU 3 ; bytes unnecessarily written at the end of the data
; Gen 2 to Gen 2 link party data structure
DEF LINK_PARTY_DATA_LENGTH              EQU NAME_LENGTH + (1 + PARTY_LENGTH + 1) + 2 + (PARTYMON_STRUCT_LENGTH + NAME_LENGTH * 2) * PARTY_LENGTH + LINK_PARTY_DATA_PADDING
; Gen 2 to Gen 1 link party data structure (Time Capsule)
DEF LINK_TIME_CAPSULE_PARTY_DATA_LENGTH EQU NAME_LENGTH + (1 + PARTY_LENGTH + 1) + (REDMON_STRUCT_LENGTH + NAME_LENGTH * 2) * PARTY_LENGTH + LINK_PARTY_DATA_PADDING
