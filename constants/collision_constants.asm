...
DEF COLL_SKATE_HOP_RIGHT   EQU $d0
DEF COLL_SKATE_HOP_LEFT          EQU $d1
DEF COLL_SKATE_HOP_UP            EQU $d2 ; unused
DEF COLL_SKATE_HOP_DOWN          EQU $d3
DEF COLL_SKATE_HOP_DOWN_RIGHT    EQU $d4
...
DEF HI_NYBBLE_SKATE_JUMP EQU $d0
