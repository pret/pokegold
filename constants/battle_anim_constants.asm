...
; BattleBGEffects indexes (see engine/battle_anims/bg_effects.asm)
	...
	const BATTLE_BG_EFFECT_WOBBLE_MON                       ; 25
	const BATTLE_BG_EFFECT_REMOVE_MON                       ; 26
	const BATTLE_BG_EFFECT_WAVE_DEFORM_MON                  ; 27
	const BATTLE_BG_EFFECT_PSYCHIC                          ; 28
	const BATTLE_BG_EFFECT_BETA_SEND_OUT_MON1               ; 29
	const BATTLE_BG_EFFECT_BETA_SEND_OUT_MON2               ; 2a
	const BATTLE_BG_EFFECT_FLAIL                            ; 2b
	const BATTLE_BG_EFFECT_BETA_PURSUIT                     ; 2c
