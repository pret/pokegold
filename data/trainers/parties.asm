...
BugsyGroup:
	...
	db 21, LEDIAN,     AGILITY, COMET_PUNCH, LIGHT_SCREEN, BATON_PASS
	db 21, PINSIR,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
	db 23, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db -1 ; end
