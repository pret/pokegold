...
; Dragon Fang now correctly boosts Dragon-type moves (bug fix)
; DRAGON_FANG
...
; GOLD_BERRY - now heals 25% max HP like Sitrus Berry
	item_attribute 10, HELD_BERRY_QUARTER, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; SQUIRTBOTTLE
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; ITEM_B0
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
