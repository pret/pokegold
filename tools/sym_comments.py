...
"""
Usage: python sym_comments.py file.asm [pokegold.sym] > file_commented.asm
...
def main():
	if len(sys.argv) not in {2, 3}:
		print(f'Usage: {sys.argv[0]} file.asm [pokegold.sym] > file_commented.asm', file=sys.stderr)
		sys.exit(1)
