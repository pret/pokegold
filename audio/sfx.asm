...
Sfx_PlacePuzzlePieceDown_Ch8: ; f1cf5
	noise $2, $f7, $24
	noise $2, $f7, $34
	noise $4, $f7, $44
	noise $8, $f4, $55
...
Sfx_EnterDoor_Ch8: ; f1d05
	noise $9, $f1, $44
	noise $8, $d1, $43
	endchannel
; f1d0c

Sfx_SwitchPokemon_Ch5: ; f1d0c
	dutycycle $2
	sound $8, $e1, $0740
	endchannel
; f1d13

Sfx_SwitchPokemon_Ch6: ; f1d13
	dutycycle $2
	sound $2, $8, $0000
	sound $8, $b1, $0741
	endchannel
...
Sfx_PokeballsPlacedOnTable_Ch5: ; f1d1e
	dutycycle $2
	soundinput $3a
	sound $4, $f2, $0200
	soundinput $22
...
Sfx_ReadText2_Ch5: ; f1d87
Sfx_ReadText_Ch5: ; f1d87
	dutycycle $2
	sound $0, $91, $07c0
	sound $0, $81, $07d0
	sound $0, $91, $07c0
...
Sfx_Poison_Ch5: ; f1da9
Sfx_Poison_branch_f1da9: ; f1da9
	dutycycle $0
	soundinput $14
	sound $4, $f2, $0600
	loopchannel 4, Sfx_Poison_branch_f1da9
	sound $f, $f3, $0600
	soundinput $8
	endchannel
; f1dbc

Sfx_FullHeal_Ch5: ; f1dbc
	dutycycle $2
	soundinput $14
	sound $4, $f2, $0600
	sound $4, $f2, $0600
...
Sfx_SecondPartOfItemfinder_Ch5: ; f1e63
	dutycycle $2
	soundinput $2c
	sound $4, $f2, $0500
	soundinput $22
...
Sfx_BallPoof_Ch8: ; f1ffc
	noise $f, $a2, $22
	endchannel
; f2000

Sfx_Unknown3A_Ch5: ; f2000
	sound $f, $d1, $0200
	soundinput $8
	endchannel
; f2007

Sfx_Unknown3A_Ch8: ; f2007
	noise $4, $f5, $33
	noise $8, $f4, $22
	noise $f, $f2, $21
	endchannel
...
Sfx_SlotMachineStart_Ch5: ; f2033
	dutycycle $2
	soundinput $44
	sound $f, $f0, $04f0
	soundinput $17
...
Sfx_SlotMachineStart_Ch6: ; f2044
	dutycycle $2
	sound $f, $92, $0600
	sound $f, $92, $0782
	endchannel
...
Sfx_MovePuzzlePiece_Ch8: ; f208a
	noise $8, $f1, $54
	endchannel
; f208e

Sfx_CometPunch_Ch8: ; f208e
	noise $f, $8f, $11
	noise $4, $ff, $12
	noise $a, $f1, $55
	endchannel
...
Sfx_Scratch_Ch8: ; f20a2
	noise $f, $9f, $23
	noise $8, $f1, $21
	endchannel
; f20a9

Sfx_Vicegrip_Ch8: ; f20a9
	noise $2, $e1, $4b
	noise $a, $f1, $44
	noise $2, $e1, $3a
	noise $6, $f1, $34
...
Sfx_WingAttack_Ch8: ; f20cd
Sfx_WingAttack_branch_f20cd: ; f20cd
	noise $8, $4f, $23
	noise $4, $c4, $22
	noise $6, $f2, $23
	loopchannel 4, Sfx_WingAttack_branch_f20cd
	endchannel
; f20db

Sfx_Whirlwind_Ch8: ; f20db
	noise $8, $4f, $33
	noise $4, $c4, $22
	noise $6, $f2, $23
	noise $f, $f2, $22
...
Sfx_Headbutt_Ch8: ; f2125
	noise $4, $ff, $55
	noise $8, $f1, $65
	endchannel
; f212c

Sfx_HornAttack_Ch8: ; f212c
	noise $2, $84, $43
	noise $2, $c4, $22
	noise $8, $f2, $34
	endchannel
...
Sfx_Tackle_Ch8: ; f2136
	noise $4, $f1, $34
	noise $f, $f2, $64
	endchannel
; f213d

Sfx_PoisonSting_Ch8: ; f213d
	noise $2, $f1, $22
	noise $f, $f2, $12
	endchannel
; f2144

Sfx_Powder_Ch8: ; f2144
	noise $2, $c2, $1
	noise $f, $f4, $1
	noise $f, $f2, $1
	endchannel
...
Sfx_KarateChop_Ch8: ; f2197
	noise $2, $d2, $32
	noise $f, $f2, $43
	endchannel
; f219e

Sfx_Submission_Ch8: ; f219e
	noise $2, $f2, $43
	noise $4, $b5, $32
	noise $9, $86, $31
	noise $7, $64, $0
...
Sfx_WaterGun_Ch8: ; f21b9
	noise $f, $3f, $22
	noise $f, $f2, $21
	endchannel
; f21c0

Sfx_SwordsDance_Ch8: ; f21c0
	noise $f, $4f, $41
	noise $8, $8f, $41
	noise $8, $cf, $41
	noise $8, $f2, $42
...
Sfx_Supersonic_Ch5: ; f21e6
	dutycycle $2
	sound $f, $3f, $07c0
Sfx_Supersonic_branch_f21ec: ; f21ec
	sound $f, $df, $07c0
	loopchannel 4, Sfx_Supersonic_branch_f21ec
	sound $f, $d1, $07c0
	endchannel
; f21f9

Sfx_Supersonic_Ch6: ; f21f9
	unknownmusic0xde $b3
	sound $f, $2f, $07c8
Sfx_Supersonic_branch_f21ff: ; f21ff
	sound $f, $cf, $07c7
	loopchannel 4, Sfx_Supersonic_branch_f21ff
	sound $f, $c1, $07c8
	endchannel
; f220c

Sfx_Supersonic_Ch8: ; f220c
Sfx_Supersonic_branch_f220c: ; f220c
	noise $3, $97, $12
	noise $3, $a1, $11
	loopchannel 10, Sfx_Supersonic_branch_f220c
	endchannel
; f2217

Sfx_Leer_Ch5: ; f2217
Sfx_Leer_branch_f2217: ; f2217
	dutycycle $0
	sound $0, $f1, $07c0
	sound $0, $f1, $0700
	loopchannel 12, Sfx_Leer_branch_f2217
	endchannel
; f2226

Sfx_Leer_Ch6: ; f2226
Sfx_Leer_branch_f2226: ; f2226
	unknownmusic0xde $b3
	sound $0, $e1, $07c1
	sound $0, $e1, $0701
	loopchannel 12, Sfx_Leer_branch_f2226
	endchannel
; f2235

Sfx_Leer_Ch8: ; f2235
Sfx_Leer_branch_f2235: ; f2235
	noise $1, $d1, $49
	noise $1, $d1, $29
	loopchannel 6, Sfx_Leer_branch_f2235
	endchannel
; f2240

Sfx_Ember_Ch5: ; f2240
Sfx_Ember_branch_f2240: ; f2240
	unknownmusic0xde $c9
	sound $b, $f3, $0120
	sound $9, $d3, $0150
	loopchannel 5, Sfx_Ember_branch_f2240
	sound $8, $e3, $0130
	sound $f, $c2, $0110
	endchannel
; f2257
...
Sfx_Ember_Ch8: ; f2257
Sfx_Ember_branch_f2257: ; f2257
	noise $a, $f3, $35
	noise $e, $f6, $45
	loopchannel 4, Sfx_Ember_branch_f2257
	noise $c, $f4, $bc
	noise $c, $f5, $9c
	noise $f, $f4, $ac
	endchannel
...
Sfx_Bubblebeam_Ch5: ; f226b
Sfx_Bubblebeam_branch_f226b: ; f226b
	unknownmusic0xde $39
	sound $4, $f4, $0600
	sound $3, $c4, $0500
	sound $5, $b5, $0600
	sound $d, $e2, $06c0
	loopchannel 3, Sfx_Bubblebeam_branch_f226b
	sound $8, $d1, $0600
	endchannel
; f2286

Sfx_Bubblebeam_Ch6: ; f2286
Sfx_Bubblebeam_branch_f2286: ; f2286
	unknownmusic0xde $8d
	sound $5, $e4, $05e0
	sound $4, $b4, $04e0
	sound $6, $a5, $05e8
	sound $e, $d1, $06a0
	loopchannel 3, Sfx_Bubblebeam_branch_f2286
	endchannel
; f229d

Sfx_Bubblebeam_Ch8: ; f229d
Sfx_Bubblebeam_branch_f229d: ; f229d
	noise $5, $c3, $33
	noise $3, $92, $43
	noise $a, $b5, $33
	noise $f, $c3, $32
	loopchannel 2, Sfx_Bubblebeam_branch_f229d
	endchannel
; f22ae

Sfx_HydroPump_Ch5: ; f22ae
Sfx_HydroPump_branch_f22ae: ; f22ae
	unknownmusic0xde $d2
	sound $3, $81, $0300
	sound $3, $c1, $0400
	sound $3, $f1, $0500
	sound $3, $b1, $0400
	sound $3, $71, $0300
	loopchannel 5, Sfx_HydroPump_branch_f22ae
	sound $8, $81, $0400
	endchannel
; f22cd

Sfx_HydroPump_Ch8: ; f22cd
Sfx_HydroPump_branch_f22cd: ; f22cd
	noise $3, $62, $22
	noise $3, $a2, $32
	noise $3, $d2, $33
	noise $3, $92, $23
	noise $3, $52, $12
	loopchannel 5, Sfx_HydroPump_branch_f22cd
	noise $8, $81, $12
	endchannel
; f22e4

Sfx_Surf_Ch5: ; f22e4
Sfx_Surf_branch_f22e4: ; f22e4
	unknownmusic0xde $39
	sound $f, $f4, $0500
	sound $f, $c4, $0400
	sound $f, $e2, $05c0
	loopchannel 3, Sfx_Surf_branch_f22e4
	endchannel
; f22f7

Sfx_Surf_Ch6: ; f22f7
Sfx_Surf_branch_f22f7: ; f22f7
	unknownmusic0xde $8d
	sound $7, $e4, $0430
	sound $f, $b4, $0330
	sound $f, $a2, $0438
	loopchannel 4, Sfx_Surf_branch_f22f7
	endchannel
; f230a

Sfx_Surf_Ch8: ; f230a
Sfx_Surf_branch_f230a: ; f230a
	noise $9, $f4, $44
	noise $9, $f2, $43
	noise $f, $f4, $42
	noise $f, $f4, $41
	loopchannel 3, Sfx_Surf_branch_f230a
	endchannel
; f231b

Sfx_Psybeam_Ch5: ; f231b
Sfx_Psybeam_branch_f231b: ; f231b
	unknownmusic0xde $a1
	sound $a, $f1, $0640
	sound $a, $f3, $0680
	sound $a, $f2, $0620
	loopchannel 4, Sfx_Psybeam_branch_f231b
	sound $a, $f1, $0640
	endchannel
; f2332

Sfx_Psybeam_Ch6: ; f2332
Sfx_Psybeam_branch_f2332: ; f2332
	unknownmusic0xde $b3
	sound $a, $f3, $0571
	sound $7, $e3, $0531
	sound $a, $f1, $0551
	loopchannel 4, Sfx_Psybeam_branch_f2332
	sound $a, $f1, $0571
	endchannel
; f2349

Sfx_Psybeam_Ch8: ; f2349
Sfx_Psybeam_branch_f2349: ; f2349
	noise $2, $d1, $4a
	noise $2, $d2, $2a
	loopchannel 21, Sfx_Psybeam_branch_f2349
	endchannel
; f2354

Sfx_Charge_Ch5: ; f2354
Sfx_Charge_branch_f2354: ; f2354
	dutycycle $0
	sound $2, $f1, $0200
	sound $3, $f1, $0700
	sound $4, $f1, $0500
	sound $5, $f1, $07f0
	loopchannel 8, Sfx_Charge_branch_f2354
	endchannel
; f236b

Sfx_Charge_Ch6: ; f236b
Sfx_Charge_branch_f236b: ; f236b
	unknownmusic0xde $b3
	sound $2, $e1, $0302
	sound $3, $e1, $07f2
	sound $4, $e1, $0602
	sound $5, $e1, $0702
	loopchannel 8, Sfx_Charge_branch_f236b
	endchannel
; f2382

Sfx_Charge_Ch8: ; f2382
Sfx_Charge_branch_f2382: ; f2382
	noise $2, $d3, $10
	noise $3, $d3, $11
	noise $2, $d2, $10
	noise $5, $d2, $12
	loopchannel 9, Sfx_Charge_branch_f2382
	endchannel
; f2393

Sfx_Thundershock_Ch5: ; f2393
Sfx_Thundershock_branch_f2393: ; f2393
	unknownmusic0xde $2b
	sound $3, $f1, $07f0
	sound $4, $f2, $0200
	loopchannel 8, Sfx_Thundershock_branch_f2393
	endchannel
; f23a2

Sfx_Thundershock_Ch6: ; f23a2
Sfx_Thundershock_branch_f23a2: ; f23a2
	unknownmusic0xde $b3
	sound $4, $e2, $0202
	sound $4, $e1, $07e2
	loopchannel 9, Sfx_Thundershock_branch_f23a2
	endchannel
; f23b1

Sfx_Thundershock_Ch8: ; f23b1
Sfx_Thundershock_branch_f23b1: ; f23b1
	noise $4, $ff, $43
	noise $4, $f2, $44
	loopchannel 9, Sfx_Thundershock_branch_f23b1
	endchannel
; f23bc

Sfx_Psychic_Ch5: ; f23bc
	dutycycle $2
	soundinput $f7
	sound $8, $c4, $07bd
	sound $8, $c4, $07be
...
Sfx_BoneClub_Ch6: ; f2442
	dutycycle $3
	sound $8, $f1, $0701
	endchannel
; f2449

Sfx_Sharpen_Ch5: ; f2449
	dutycycle $2
	sound $6, $f1, $0500
	sound $6, $f1, $0580
	sound $6, $f1, $0600
...
Sfx_HyperBeam_Ch5: ; f24c7
	...
	sound $2, $f1, $0700
	sound $2, $f1, $07d0
Sfx_HyperBeam_branch_f24f5: ; f24f5
	sound $2, $f1, $0700
	sound $2, $f1, $07e0
	loopchannel 12, Sfx_HyperBeam_branch_f24f5
	sound $f, $f1, $0700
	endchannel
; f2506

Sfx_HyperBeam_Ch6: ; f2506
	unknownmusic0xde $b3
	sound $2, $f1, $0781
	sound $2, $f1, $0701
	sound $2, $f1, $0791
	...
	sound $2, $f1, $0701
	sound $2, $f1, $07d1
Sfx_HyperBeam_branch_f2534: ; f2534
	sound $2, $f1, $0701
	sound $2, $f1, $07e1
	loopchannel 12, Sfx_HyperBeam_branch_f2534
	sound $f, $f1, $0701
	endchannel
; f2545

Sfx_HyperBeam_Ch8: ; f2545
Sfx_HyperBeam_branch_f2545: ; f2545
	noise $1, $d1, $49
	noise $1, $d1, $29
	loopchannel 26, Sfx_HyperBeam_branch_f2545
	endchannel
; f2550

Sfx_Unknown60_Ch8: ; f2550
	noise $6, $20, $10
	noise $6, $2f, $40
	noise $6, $4f, $41
	noise $6, $8f, $41
...
Sfx_Unknown61_Ch8: ; f2569
	noise $4, $d1, $41
	endchannel
; f256d

Sfx_Unknown62_Ch8: ; f256d
	noise $4, $c1, $42
	endchannel
; f2571

Sfx_Unknown63_Ch8: ; f2571
	noise $2, $6f, $21
	noise $2, $af, $31
	noise $f, $f2, $41
	endchannel
...
Sfx_TitleScreenEntrance_Ch8: ; f2582
	noise $8, $3c, $20
	noise $6, $a0, $20
	noise $8, $b0, $21
	noise $a, $c0, $22
...
Sfx_GetCoinFromSlots_Ch5: ; f25a1
	dutycycle $2
	sound $2, $f1, $0700
	sound $8, $81, $07e0
	endchannel
...
Sfx_Unknown5F_Ch5: ; f25f5
Sfx_Unknown5F_branch_f25f5: ; f25f5
	sound $2, $f7, $0601
	sound $2, $f7, $0701
	loopchannel 8, Sfx_Unknown5F_branch_f25f5
	endchannel
; f2602

Sfx_Unknown5F_Ch6: ; f2602
	sound $1, $f7, $ffff
	sound $2, $f7, $0602
	sound $2, $f7, $0702
	loopchannel 8, Sfx_Unknown5F_branch_f25f5
...
Sfx_HangUp_Ch5: ; f26cf
	dutycycle $2
	sound $4, $b8, $077b
	sound $2, $21, $077b
	sound $10, $0, $0000
Sfx_HangUp_branch_f26dd: ; f26dd
Sfx_NoSignal_Ch5: ; f26dd
Sfx_NoSignal_branch_f26dd: ; f26dd
	dutycycle $2
	sound $14, $e8, $070b
	sound $1c, $0, $0000
	loopchannel 3, Sfx_HangUp_branch_f26dd
	endchannel
; f26ec

Sfx_Sandstorm_Ch8: ; f26ec
Sfx_Sandstorm_branch_f26ec: ; f26ec
Sfx_Unknown5F_Ch8: ; f26ec
Sfx_Unknown5F_branch_f26ec: ; f26ec
	noise $1, $f8, $41
	noise $2, $9c, $24
	noise $0, $0, $0
	noise $3, $59, $16
	noise $2, $0, $0
	loopchannel 3, Sfx_Sandstorm_branch_f26ec
	endchannel
; f2700

Sfx_Elevator_Ch5: ; f2700
	dutycycle $2
	soundinput $5a
Sfx_Elevator_branch_f2704: ; f2704
	sound $2, $f1, $0300
	loopchannel 48, Sfx_Elevator_branch_f2704
	soundinput $8
	dutycycle $2
	sound $f, $f3, $0730
	sound $8, $65, $0730
...
Sfx_Elevator_Ch6: ; f2729
Sfx_Elevator_Ch7: ; f2729
	sound $60, $0, $0000
	sound $53, $0, $0000
	endchannel
; f2732

Sfx_Elevator_Ch8: ; f2732
	noise $60, $0, $0
	noise $53, $0, $0
	endchannel
; f2739
